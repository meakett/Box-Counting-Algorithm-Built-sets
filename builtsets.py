...
#V Cross
image1_url = "https://cdn.phototourl.com/free/2026-05-13-a8b7caaa-2a59-4b73-a5fc-e3245cc5d689.png"
...
plt.ylabel('log N')
plt.title('Vicsek Cross log N VS log 1/$\epsilon$')
print("Dimension=", D1)
print('width=', Lx ,'height=',Ly)


#Sirpinski trngle
image2_url = "https://cdn.phototourl.com/free/2026-05-13-862eb19d-e6fe-4811-8299-e01e9c5cf34a.png"
...
plt.xlabel('log 1/$\epsilon$')
plt.ylabel('log N')
plt.title('Seirpinksi triangle log N VS log 1/$\epsilon$')
print("Dimension=", D2)
print("width=",Lx, "height=",Ly)
