...
#lightning 1
image1_url = "https://cdn.phototourl.com/free/2026-06-15-a2e4ec33-17cc-4445-aab7-00eb2c8fc484.jpg"
...
img1 = ImageOps.invert(img1) #inverts the image so background is white, lightning is black
...
thresh = 150  # 0 is black, 255 is white, midway point between the two
...
plt.ylabel('log N')
plt.title('Lightning 1 log N VS log 1/$\epsilon$')
print("Dimension=", D1)
print('width=', Lx ,'height=',Ly)

#lightning 2
image2_url = "https://cdn.phototourl.com/free/2026-06-15-aec6a268-c6b4-4d18-864f-06f3d403d573.jpg"
...
img2 = ImageOps.invert(img2) #inverts the image so background is white, lightning is black
...
#the following defines the black or white value of a (i,j)
thresh = 120  # 0 is black 255 is white, midway point between the two
...
plt.xlabel('log 1/$\epsilon$')
plt.ylabel('log N')
plt.title('Lightining 2 log N VS log 1/$\epsilon$')
plt.show()
print("Dimension=", D2)
print("width=",Lx, "height=",Ly)
...
#lightining 3
image3_url = "https://cdn.phototourl.com/free/2026-06-15-79e854c0-9a8c-417c-8511-42d1b8ef2d5e.jpg"
...
img3 = ImageOps.invert(img3) #inverts the image so background is white, lightining is black
...
plt.xlabel('log 1/$\epsilon$')
plt.ylabel('log N')
plt.title('Lightning 3 log N VS log 1/$\epsilon$')
plt.show()
print("Dimension=", D3)
print("width=",Lx, "height=",Ly)

#lightining4
image4_url = "https://cdn.phototourl.com/free/2026-06-14-d45d7763-93cf-4d56-933e-6f264ca4f9a5.jpg"
...
img4 = ImageOps.invert(img4) #inverts the image so background is white, lightining is black
...
plt.xlabel('log 1/$\epsilon$')
plt.ylabel('log N')
plt.title('lightning 4 log N VS log 1/$\epsilon$')
plt.show()
print("Dimension=", D4)
print("width=",Lx, "height=",Ly)
...
plt.xlabel('log 1/$\epsilon$')
plt.ylabel('log N')
plt.title('Lightning avg log N VS log 1/$\epsilon$')
plt.show()
print("Dimension=", D5)
